      ...
      <nav class="navbar navbar-expand-md bg-light fixed-top2">
        ...
        <!--<ul class="navbar-nav nav-pills">-->
          <ul class="nav nav-pills">
            <li class="nav-item"><a class="nav-link" href="./?<?=url_query_make('task=bot&p=users&b=tg');?>"><i class="fa fa-telegram"></i> Telegram</a></li>
            <li class="nav-item"><a class="nav-link" href="./?task=events&p=list"><i class="fa fa-calendar-o"></i> Мероприятия</a></li>
            <li class="nav-item"><a class="nav-link" href="./?<?=url_query_make('task=events&p=edit&i=0');?>"><i class="fa fa-calendar-plus-o"></i> Добавить новое</a></li>
...
if(in_array($_GET['task'], ['events', 'bot', 'users'], true))
