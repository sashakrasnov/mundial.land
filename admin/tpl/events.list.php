        ...
        $(document).ready(function() {
            ...
            $('#event-modal').on('show.bs.modal', function(event) {
                ...
                $.getJSON('./event.php?' + url, function(data) {
                    ...
                    modal.find('#event-map').html(data['map']);
                    modal.find('#event-link').html(data['link']);
                });
            });
        });
        </script>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body ">
                        ...
                        <div class="form-group">
                            <strong>Описание: </strong><span id="event-descr"></span>
                        </div>
                        <div class="form-group">
                            <strong>Карта: </strong><span id="event-map"></span>
                        </div>
                        <div class="form-group">
                            <strong>Отчет: </strong><span id="event-link"></span>
                        </div>
                    </div>
